...
[Ветки](#branch)
   ...
   - [Объединение веток](#merge_branch)
...
3.  Изменение нескольких сообщений
    Пример:* `git rebase -i HEAD~3`
...
### <a id='create_branch'>Создание и переход на ветку</a>
...
### <a id='comparison_branch'>Сравнение веток</a>

1. Сравнить ветки

      *Пример:* `git diff <название_ветки1> <название_ветки2>`
...
### <a id='merge_branch'>Объединение веток</a>
